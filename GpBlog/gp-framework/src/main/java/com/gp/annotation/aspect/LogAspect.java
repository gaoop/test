package com.gp.annotation.aspect;

import com.alibaba.fastjson.JSON;
import com.gp.annotation.SystemLog;
...
public class LogAspect {
    ...
    @Pointcut("@annotation(com.gp.annotation.SystemLog)")
    public void pt(){
    ...
    private void HandlerBefore(ProceedingJoinPoint joinPoint) {
        ...
        log.info("Class Method   : {}.{}",joinPoint.getSignature().
                getDeclaringTypeName(),((MethodSignature)joinPoint
